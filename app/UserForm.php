...
class UserForm extends Model
{
     ...
     */
    protected $fillable = [
        'user_id', 'form_key', 'name','description','fields','columns_each_row', 'image', 'image_pos', 'hide','email','success_message','status','name_collection','email_collection','submit_text','email_collection_title','auto_response','is_deleted' ,'response_text','convert_kit_opt','convert_kit_form_id'
    ];
